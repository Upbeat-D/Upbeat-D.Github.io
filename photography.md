...
<div class="page-content wc-container">
	...
	<div class="post-box" style="margin-bottom:48px">
		...
		<div class="box-text">
			<a href="{{ site.url }}/photography/test">
				<h6>A NWU collection</h6>
			</a>
			<p>I spent six unforgettable years here at NWU from 2017 to 2023, and this compilation includes photos that I took at NWU. <a href="{{ site.url }}/photography/test">Read More</a></p>
		</div>
	</div>
