...
<div class="page-content wc-container">
	...
	<div class="post-box" style="margin-bottom:48px">
		...
		<div class="box-text">
			<a href="{{ site.url }}/photography/2024/05/21/ld/">
				<h6>Last days in China, 2024</h6>
			</a>
			<p>I do photography as a hobby. Being an Earth scientist granted me lots of opportunities to travel around the world and see many places that may not be easily accessible to the public... <a href="{{ site.url }}/photography/2024/05/21/ld/">Read More</a></p>
		</div>
	</div>
